 ...
 */
public class TermuxFloatServiceNew extends Service implements
    ...
    private Notification buildNotification() {
        ...
        Intent notificationIntent = new Intent(this, TermuxFloatServiceNew.class).setAction(intentAction);
        ...
        // Exit action
        Intent exitIntent = new Intent(this, TermuxFloatServiceNew.class)
        ...
        // New tab action
        Intent newTabIntent = new Intent(this, TermuxFloatServiceNew.class)
