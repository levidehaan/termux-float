...
public class TermuxFloatServiceLegacy extends Service {
    ...
    private Notification buildNotification() {
        ...
        Intent notificationIntent = new Intent(this, TermuxFloatServiceLegacy.class).setAction(intentAction);
        ...
        Intent exitIntent = new Intent(this, TermuxFloatServiceLegacy.class).setAction(TERMUX_FLOAT_SERVICE.ACTION_STOP_SERVICE);
